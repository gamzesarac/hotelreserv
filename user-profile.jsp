		...
		<div id="page-wrapper">
					...
					<form data-toggle="validator" novalidate="true">
						...
						<div class="form-group">
								<input type="password" class="form-control"   id="userPassword"  value="<% out.print(rs.getString("password")); %>" disabled="true">
                                                ...
                                                <div class="form-group">
								<input type="text" class="form-control" id="userFirstandLastname" value="<% out.print(rs.getString("firstname") + " " + rs.getString("lastname")); %>" disabled="true">
						</div>
						...
						<div class="form-group">
								...
								<input type="text" class="form-control" id="userPhone" value="<% out.print(rs.getString("telephone")); %>" disabled="true" >
                                                ...
                                                <div class="form-group">
								<input type="text" class="form-control" id="userPhone" value="<% out.print(rs.getString("birthdate")); %>" disabled="true">
						</div>
				...
				<div class="validation-grids widget-shadow" data-example-id="basic-forms"> 
					...
					<h3>User Reservations : <% out.print(reservationCount + " Total Reservation"); %></h3>
                                    ...
                                    <thead> 
                                        <tr> 
                                            <th>PNR</th> <th>Hotel Name</th> <th>Reservation Date</th> 
                                        </tr> 
                                    </thead> 
                                    ...
                                    <tbody> 
                                        ...
                                        <% 
                                       rs = st.executeQuery("select id,reservationid,pnr, hotelname, reservationdate,hotel.hotelid, hotelrooms.hotelid from user, hotel, reservation, hotelrooms where reservation.userid = user.id AND reservation.roomid = hotelrooms.roomid AND hotelrooms.hotelid = hotel.hotelid AND user.id="+userID);
                                            while(rs.next())
                                           {
                                         %>
