	...
	<div class="main-content">
		...
		<div class="panel panel-widget">
			<div class="tables">
                ...
                ResultSet rs;
                rs = st.executeQuery("select hotelid,hotelname,user_id,id,firstname,lastname from user,hotel where hotel.user_id = user.id AND hotel.status=0");
                                            ...
                                            while(rs.next())
                                                {
                                                    if(tableCount==0)         // bu if i koymazsam approve bekleyen otel kadar tablo olu?turuyor.
                                                    {
                                                        tableCount++;
                                        %>
                                <table class="table table-bordered"> <thead> <tr> <th>Hotel ID</th> <th>Hotel Name</th> <th>Hotel Owner</th> <th>Telephone</th> <th>Message</th></tr> </thead> 
                                    <tbody>
                                        <% }%>
                                        <tr> 
                                            ...
                                            <td>
                                                 <form method="post" action="messagePage.jsp">
                                                <input type="submit" name="Message" value="Message" style="width: 125px; background-color: white; border-color: white; color: black;"/>
                                                 <input type="hidden" name="hid" value="<%out.print(rs.getString("hotelid"));%>">
                                                 </form>
                                            </td> 
                                        </tr> 
                                                <% } %>
