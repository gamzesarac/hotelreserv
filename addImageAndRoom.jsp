        ...
        <div id ="container">
            ...
            <div id="main">
                ...
                <table border="4">
                   ...
                   <p> <input type = "submit" name="AddSetting" value = "Add Room" style="width: 95px; background-color: white; border-color: white; color: #014ccc; "/> <input type = "submit" value = "Add Images" name="AddSetting" style="width: 95px; background-color: white; border-color: white; color: #014ccc; "/></p>
